...
\fbox{\phantom{X}} & \textbf{Biasa}
\end{tabularx}

\vspace{1cm}

\noindent \hspace{10cm} Disahkan oleh:
...
\noindent
\begin{tabular*}{\textwidth}{@{}p{7cm}@{\extracolsep{\fill}}p{7cm}@{}}
\AuthorName & \SupervisorOne \\[0.3cm]
\end{tabular*}

\noindent
\begin{tabular*}{\textwidth}{@{}p{7cm}@{\extracolsep{\fill}}p{7cm}@{}}
& \textbf{Pembimbing Utama} \\
Alamat Tetap: \AuthorAddress & NIDN \SupervisorOneNIDN
\end{tabular*}
